...
#  this program, you will call the prefix@domain the whoSent. Your Python program will use split() to parse the
#  prefix and domain and a Python dictionary to tabulate the number of email messages received from each prefix. For
#  this code challenge, consider prefix segments to uniquely identify each whoSent. Output your dictionary in many
...
# "From"). Lines that begin with "From:" (note the colon after "From" ) do not contain the whoSent.
#   1) Count the number of found lines and output the count.
#   2) Use split() to parse the line into separate words.
#   3) Use the second word as the email whoSent.
#   4) Output the email whoSent.
#   5) Use split('@') to parse the prefix and domain
#   6) Output the email whoSent's prefix and domain
#   7) Use a Python dictionary to count the number of messages from each whoSent
...
# TODO: Where did handle come from? How was it created? What is it? What is textInEachLine?
...
# TODO: Use a Python dictionary to tabulate the number of messages from each whoSent
num_of_msgs = dict()
...
# Loop through the dictionary to find the whoSent with the most messages
big_count = None
big_word = None
...
print("\n The countMessagesFromEachSender dictionary is: ")
print(num_of_msgs)
# Output the dictionary sorted by keys
print("\n The sorted-by-keys countMessagesFromEachSender dictionary is: ")
print(sorted(num_of_msgs.keys()))
# Output the dictionary sorted by values
print("\n The sorted-by-values countMessagesFromEachSender dictionary is: ")
...
# Advanced: Use prefix@domain as the whoSent and the get() method in dictionary
print("\n*********** Advanced ************\n")
...
# () around k1,k2 are added for programming clarity
print("\n Sorted by key...")
